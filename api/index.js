...
const CROSS_PILLAR_IMPACT_MATRIX = {
  ...
  "People→Numbers": {
    ...
    headline: "Misaligned relationships have a price tag.",
    explanation: "This isn't about bad relationships — it's about unstructured ones. When your network isn't strategically aligned with your financial goals, you miss partnerships, leave negotiation leverage on the table, and carry relational overhead that doesn't compound. Structuring your People pillar protects your Numbers.",
  ...
  "People→Knowledge": {
    ...
    explanation: "This isn't about whether you can build relationships — it's about whether your current network is structured to accelerate your knowledge growth. When your inner circle isn't aligned with where you're going, you end up learning alone instead of learning from people who've already been there.",
...
— The Value Engine
   ValueToVictory.com`;
            subject = `Your P.I.N.K.'s Value Engine Score: ${eMasterScore} (${eScoreRange}) — Personal Report Ready`;
          } else {
...
— The Value Engine
   ValueToVictory.com`;
            subject = `Your P.I.N.K.'s Value Engine Score: ${eMasterScore} (${eScoreRange}) — Unlock Your Full Report`;
          }
...
<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td style="padding:28px 40px 36px 40px;text-align:center;"><p style="margin:0 0 8px 0;font-family:Arial,Helvetica,sans-serif;font-size:14px;font-weight:700;color:#4a4a64;letter-spacing:1.5px;text-transform:uppercase;">Value to Victory</p><p style="margin:0 0 12px 0;font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#3a3a54;line-height:1.6;">Don't guess. Run the system.</p><p style="margin:0 0 8px 0;font-family:Arial,Helvetica,sans-serif;font-size:11px;color:#3a3a54;">You're receiving this because you completed the P.I.N.K.'s Value Engine Assessment.</p><p style="margin:0;font-family:Arial,Helvetica,sans-serif;font-size:11px;color:#6a6a84;">To unsubscribe, reply with UNSUBSCRIBE in the subject line.</p><p style="margin:12px 0 0 0;font-family:Arial,Helvetica,sans-serif;font-size:10px;color:#2a2a44;">&copy; 2026 Value to Victory | Goodview, VA | valuetovictory.com</p></td></tr></table>
      ...
      const subject = `Your P.I.N.K.'s Value Engine Score: ${masterScore} (${scoreRange}) \u2014 Personal Report Ready`;
...
— The Value Engine
   ValueToVictory.com`;
        ...
        subject = `Team Analysis Report — P.I.N.K.'s Value Engine Assessment`;
   ...
   ValueToVictory.com`,
    ...
    if (req.method === 'GET' && url.startsWith('/coaching/verify')) {
      ...
      try {
        ...
        report += `1. The P.I.N.K.'s Value Engine Assessment — your diagnostic baseline (valuetovictory.com)\n`;
